...
namespace S_Innovations.Security.Tokens
{
    public class JsonWebTokenHandler : SecurityTokenHandler
    {
        ...
        private string[] _identifier = new string[] { JsonWebToken, JwtConstants.JWT };
        ...
        public override bool CanReadToken(XmlReader reader)
        {
            return
                ...
                reader.GetAttribute(WSSecurity10Constants.Attributes.ValueType) == JsonWebToken;
        }
        ...
        public override void WriteToken(XmlWriter writer, SecurityToken token)
        {
            ...
            writer.WriteAttributeString(WSSecurity10Constants.Attributes.ValueType, JsonWebToken);
